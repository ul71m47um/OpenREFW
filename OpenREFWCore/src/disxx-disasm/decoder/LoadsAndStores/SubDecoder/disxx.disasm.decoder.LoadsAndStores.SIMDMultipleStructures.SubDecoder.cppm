export module disxx.disasm.decoder.LoadsAndStores.SIMDMultipleStructures.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::LoadsAndStores::SIMDMultipleStructures
{
