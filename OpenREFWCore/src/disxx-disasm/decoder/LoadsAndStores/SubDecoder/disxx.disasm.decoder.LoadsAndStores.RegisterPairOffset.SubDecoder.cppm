export module disxx.disasm.decoder.LoadsAndStores.RegisterPairOffset.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::LoadsAndStores::RegisterPairOffset
{
...
} /* disxx::disasm::decoder::LoadsAndStores::RegisterPairOffset */
