export module disxx.disasm.decoder.LoadsAndStores.CompareAndSwapPair.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::LoadsAndStores::CompareAndSwapPair
{
...
} /* disxx::disasm::decoder::LoadsAndStores::CompareAndSwapPair */
