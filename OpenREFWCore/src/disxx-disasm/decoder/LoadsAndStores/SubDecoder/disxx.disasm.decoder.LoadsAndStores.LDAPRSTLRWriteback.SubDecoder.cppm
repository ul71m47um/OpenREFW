export module disxx.disasm.decoder.LoadsAndStores.LDAPRSTLRWriteback.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::LoadsAndStores::LDAPRSTLRWriteback
{
