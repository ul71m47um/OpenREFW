export module disxx.disasm.decoder.LoadsAndStores.RegisterImmediatePostIndexed.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::LoadsAndStores::RegisterImmediatePostIndexed
{
...
} /* disxx::disasm::decoder::LoadsAndStores::RegisterImmediatePostIndexed */
