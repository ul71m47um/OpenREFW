export module disxx.disasm.decoder.LoadsAndStores.CompareAndSwap.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::LoadsAndStores::CompareAndSwap
{
...
} /* disxx::disasm::decoder::LoadsAndStores::CompareAndSwap */
