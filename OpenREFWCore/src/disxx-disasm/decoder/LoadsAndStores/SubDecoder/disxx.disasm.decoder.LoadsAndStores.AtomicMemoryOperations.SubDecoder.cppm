export module disxx.disasm.decoder.LoadsAndStores.AtomicMemoryOperations.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::LoadsAndStores::AtomicMemoryOperations
{
