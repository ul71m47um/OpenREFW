export module disxx.disasm.decoder.LoadsAndStores.OneHundredAndTwentyEightBitAtomicMemoryOperations.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::LoadsAndStores::OneHundredAndTwentyEightBitAtomicMemoryOperations
{
...
} /* disxx::disasm::decoder::LoadsAndStores::OneHundredAndTwentyEightBitAtomicMemoryOperations */
