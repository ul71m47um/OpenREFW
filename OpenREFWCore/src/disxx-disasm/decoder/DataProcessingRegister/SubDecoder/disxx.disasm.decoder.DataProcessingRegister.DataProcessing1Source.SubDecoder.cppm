export module disxx.disasm.decoder.DataProcessingRegister.DataProcessing1Source.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::DataProcessingRegister::DataProcessing1Source
{
