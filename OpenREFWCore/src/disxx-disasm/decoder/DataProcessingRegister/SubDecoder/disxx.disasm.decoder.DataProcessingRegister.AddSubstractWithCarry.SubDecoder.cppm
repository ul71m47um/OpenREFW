export module disxx.disasm.decoder.DataProcessingRegister.AddSubstractWithCarry.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::DataProcessingRegister::AddSubstractWithCarry
{
