export module disxx.disasm.decoder.DataProcessingRegister.AddSubstractShiftedRegister.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::DataProcessingRegister::AddSubstractShiftedRegister
{
	class __attribute__((visibility("default"))) [[nodiscard]] SubDecoder final : public disxx::disasm::decoder::abstract::SubDecoder
	{
	  public:
		...
		virtual ~SubDecoder(void) noexcept override = default;
