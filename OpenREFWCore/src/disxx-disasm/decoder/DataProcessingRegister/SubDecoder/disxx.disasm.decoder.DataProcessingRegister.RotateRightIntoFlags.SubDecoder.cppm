export module disxx.disasm.decoder.DataProcessingRegister.RotateRightIntoFlags.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::DataProcessingRegister::RotateRightIntoFlags
{
