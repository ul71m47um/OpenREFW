export module disxx.disasm.decoder.DataProcessingRegister.LogicalShiftedRegister.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::DataProcessingRegister::LogicalShiftedRegister
{
