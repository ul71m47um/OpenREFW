export module disxx.disasm.decoder.DataProcessingScalarFPAndAdvancedSIMD.CryptographicThreeRegisterSHA.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::DataProcessingScalarFPAndAdvancedSIMD::CryptographicThreeRegisterSHA
{
	class __attribute__((visibility("default"))) [[nodiscard]] SubDecoder final : public disxx::disasm::decoder::abstract::SubDecoder
	{
	  public:
...
} /* disxx::disasm::decoder::DataProcessingScalarFPAndAdvancedSIMD::CryptographicThreeRegisterSHA */
