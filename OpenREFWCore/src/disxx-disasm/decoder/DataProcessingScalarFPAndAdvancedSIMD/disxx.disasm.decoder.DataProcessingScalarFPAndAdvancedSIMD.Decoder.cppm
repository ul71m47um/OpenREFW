export module disxx.disasm.decoder.DataProcessingScalarFPAndAdvancedSIMD.Decoder;

import disxx.disasm.decoder.abstract.Decoder;
import disxx.utility.error.DisassemblyError;

export namespace disxx::disasm::decoder::DataProcessingScalarFPAndAdvancedSIMD
{
	class __attribute__((visibility("default"))) [[nodiscard]] Decoder final : public disxx::disasm::decoder::abstract::Decoder
	{
	  protected:
		std::expected
		<
...
} /* disxx::disasm::decoder::DataProcessingScalarFPAndAdvancedSIMD */
