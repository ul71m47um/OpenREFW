export module disxx.disasm.decoder.BranchesExceptionsAndSystemInstructions.SystemRegisterMove.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::BranchesExceptionsAndSystemInstructions::SystemRegisterMove
{
...
} /* disxx::disasm::decoder::BranchesExceptionsAndSystemInstructions::SystemRegisterMove */
