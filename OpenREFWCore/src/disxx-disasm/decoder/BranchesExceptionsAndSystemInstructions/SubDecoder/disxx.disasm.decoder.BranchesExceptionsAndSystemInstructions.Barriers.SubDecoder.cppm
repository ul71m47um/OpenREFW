export module disxx.disasm.decoder.BranchesExceptionsAndSystemInstructions.Barriers.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::BranchesExceptionsAndSystemInstructions::Barriers
{
