export module disxx.disasm.decoder.DataProcessingImmediate.MinMaxImmediate.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::DataProcessingImmediate::MinMaxImmediate
{
