export module disxx.disasm.decoder.DataProcessingImmediate.MoveWideImmediate.SubDecoder;

import disxx.disasm.decoder.abstract.SubDecoder;

export namespace disxx::disasm::decoder::DataProcessingImmediate::MoveWideImmediate
{
